!(function (t, e) {
    ...
    Object.defineProperty(g, "version", { enumerable: !0, configurable: !0, writable: !0, value: "5.0.15" }),
    ...
    class Y extends b {
        ...
        attachObserver() {
            var t;
            const e = () =>
                Math.abs(this.containerRect.width - this.container.getBoundingClientRect().width) > 0.1 || Math.abs(this.containerRect.height - this.container.getBoundingClientRect().height) > 0.1;
            this.resizeObserver ||
        ...
        onPointerDown(t, e, i) {
            ...
            return (
                (this.target.e = this.current.e), (this.target.f = this.current.f), this.stop(), this.isDragging || ((this.isDragging = !0), this.addTrackingPoint(e), this.emit("touchStart", t)), !0
            );
        }
        onPointerMove(t, e, i) {
            ...
            i ||
                ("string" == typeof e &&
                    ("#" === e.charAt(0)
                        ...
                        ? ((t.src = `https://maps.google.${n[1]}/?ll=${(n[2] ? n[2] + "&z=" + Math.floor(parseFloat(n[3])) + (n[4] ? n[4].replace(/^\//, "&") : "") : n[4] + "").replace(
                              /\?/,
                              "&"
                          )}&output=${n[4] && n[4].indexOf("layer=c") > 0 ? "svembed" : "embed"}`),
                          (i = "map"))
    ...
    class Pt extends b {
        ...
        onDecel(t, e = 0, i = 0) {
            ...
            h
                ? this.onChange(m)
                : ((d = g), Math.abs(c) > 5 && (d = n && s ? (c < 0 ? d - 1 : d + 1) : c < 0 ? d + 1 : d - 1), this.slideTo(d, { transition: !1, friction: t.option("decelFriction") }));
        }
        onClick(t) {
            const e = t.target,
    ...
    class jt extends b {
        ...
        focus(t) {
            ...
            let u = null;
            t
                ? (!n || h.indexOf(n) < 0) && ((u = d || s), h.length && (i === It ? (u = h[0]) : (this.lastFocus !== s && i !== kt) || (u = h[h.length - 1])))
        ...
        setContent(t, e = "", i = !0) {
            ...
            let a = null;
            if (
                (s(e) ? (a = e) : ((a = n(e + "")), s(a) || ((a = document.createElement("div")), (a.innerHTML = e + ""))),
                ["img", "picture", "iframe", "video", "audio"].includes(a.nodeName.toLowerCase()))
            ) {
                const t = document.createElement("div");
                t.appendChild(a), (a = t);
            }
